...
const navItems: NavItem[] = [
  ...
  { icon: Icons.CalenderIcon, name: "Recharge", path: "/EmRecharge" },
  { icon: Icons.UserCircleIcon, name: "Account Report", path: "/ActivationLedgerReport" },
  {
    icon: Icons.ListIcon,
    name: "Reports",
    subItems: [
      { name: "Master RTR Reports", path: "/ActivationLedgerReport" },
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar mt-2">
       ...
       <Link
              to="/signin"
              className={`btn-signout group flex items-center cursor-pointer ${
            ...
            >
              ...
              {(isExpanded || isHovered || isMobileOpen) && (
                <span className="menu-item-text px-2">Sign out</span>
              )}
            </Link>
